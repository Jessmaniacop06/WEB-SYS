...
if (
    ...
    if ($old["linkedin"] === "") {
        ...
        $errors["linkedin"] = "Enter a valid LinkedIn profile.";
    }
    ...
    if (
        ...
        $errors["photo"] = "There was an error uploading the profile picture.";
    } else {
        ...
        if (!in_array($fileType, $allowedTypes)) {
            $errors["photo"] = "Profile picture must be JPG, PNG, or WEBP.";
        } elseif (
            $_FILES["photo"]["size"] > 2 * 1024 * 1024
        ) {
            $errors["photo"] = "Profile picture must not exceed 2MB.";
        }
    }
    ...
    if (empty($errors)) {
        ...
        if (
            ...
            $errors["photo"] = "Failed to save the profile picture.";
        }
    }
...
<div class="card">
    ...
    >
        ...
        <div class="form-grid">
            ...
            <div class="form-group <?= field_class($errors, 'photo') ?>">
